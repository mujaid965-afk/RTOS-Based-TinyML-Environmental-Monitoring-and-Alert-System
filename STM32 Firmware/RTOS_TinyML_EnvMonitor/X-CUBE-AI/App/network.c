...
#define AI_NETWORK_MODEL_SIGNATURE     "0x8c4a841bc41420445a5ef39e542ac292"
...
#define AI_TOOLS_DATE_TIME   "2026-06-30T23:42:58+0530"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 900, 1, 1),
    900, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 16);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 832);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 832);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 864);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 864);
